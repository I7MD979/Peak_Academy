  ...
  return (
    <>
      ...
      <section className="scroll-reveal landing-section-dark landing-pattern-dark relative overflow-hidden landing-section-y">
        <div
          className="pointer-events-none absolute left-1/2 top-1/2 h-[min(800px,120vw)] w-[min(800px,120vw)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-landing-orange/12 blur-[120px] sm:blur-[150px]"
          aria-hidden="true"
        />

        <div className="landing-container relative z-10 text-center">
          <div className="mb-8 inline-flex h-20 w-20 rotate-12 items-center justify-center rounded-3xl border border-landing-orange/30 bg-white/8 backdrop-blur-xl sm:mb-10 sm:h-24 sm:w-24">
