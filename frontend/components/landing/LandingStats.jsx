  ...
  return (
    <section className="landing-section-light landing-pattern-light relative z-20 pb-16 pt-0 sm:pb-20 md:pb-24">
      <div className="landing-container relative -mt-10 sm:-mt-14 md:-mt-16">
        <div className="scroll-reveal landing-card-light landing-card-accent-top grid grid-cols-2 gap-4 rounded-3xl p-5 sm:gap-6 sm:p-8 md:grid-cols-4 md:gap-8 md:px-10 md:py-9">
          {items.map((item) => (
