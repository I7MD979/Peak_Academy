...
export default function AuthFormCard({ title, subtitle, children, footer, className, showLogo = false }) {
  return (
    <div className={cn("relative w-full max-w-[min(100%,28rem)] sm:max-w-[30rem]", className)}>
      ...
      <div
        className="relative overflow-hidden rounded-xl border border-outline-variant bg-surface-container-low p-6 sm:p-8 md:p-9"
        style={{ boxShadow: "0 0 40px rgba(255,122,0,0.08)" }}
      >
