...
export const STUDENT_SESSION_EMPTY_COPY = {
  ...
  mine: {
    title: "لم تسجّل في أي محاضرة بعد",
    hint: "تصفّح المحاضرات المتاحة واحجز محاضرتك الأولى."
  },
  live: {
    title: "لا توجد محاضرات مباشرة الآن",
    hint: "عند بدء مدرسك المحاضرة ستظهر هنا للدخول فوراً."
  },
  completed: {
    title: "لا توجد محاضرات منتهية",
    hint: "بعد إكمال محاضراتك المسجّل فيها ستظهر في هذا القسم."
  }
};
